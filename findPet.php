                                ...
                                <div class="rs-shop-box mb-5">
                                    ...
                                    <div class="body-text">
                                        ...
                                        <div class="meta">
                                            ...
                                            <div class="rating">
                                                <input hidden type="text" id="toLat" value="10.803775779438766" />
                                                <input hidden type="text" id="toLng" value="106.68427745770103" />
                                                <p id="result"></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="rs-shop-box mb-5">
                                    ...
                                    <div class="body-text">
                                        ...
                                        <div class="meta">
                                            <div class="price">$29</div>
                                            <div class="rating">
                                                <input hidden type="text" id="toLat" value="10.803239393152511" />
                                                <input hidden type="text" id="toLng" value="106.69010208460972" />
                                                <p id="result"></p>
                                            </div>
                                        </div>
                                    </div>
