...
<body>
	...
	<!-- BANNER -->
	<div class="section banner-page" data-background="images/post/post_bg.jpg">
		<div class="content-wrap pos-relative">
			<div class="d-flex justify-content-center bd-highlight mb-2">
				<div class="title-page">Blog List</div>
			</div>
			<p class="text-center text-white">Cap nhat thong tin tung ngay</p>
		</div>
	</div>
